              ...
              {formData.password && (
                <div className="flex items-center gap-3 mt-2">
                  <div className="flex-1 flex gap-1">
                    <div
                      className={`flex-1 h-1 rounded ${strength.level >= 1 ? strength.color : "bg-border"}`}
                    ></div>
                    <div
                      className={`flex-1 h-1 rounded ${strength.level >= 2 ? strength.color : "bg-border"}`}
                    ></div>
                    <div
                      className={`flex-1 h-1 rounded ${strength.level >= 3 ? strength.color : "bg-border"}`}
                    ></div>
                  </div>
                  <span
