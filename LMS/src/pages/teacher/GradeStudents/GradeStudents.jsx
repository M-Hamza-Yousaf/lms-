...
function GradeStudents() {
  const [submissions] = useState([
    { id: 1, student: 'Ali Khan', assignment: 'React Components', course: 'React Basics', submitted: '2026-06-10', grade: '' },
    { id: 2, student: 'Sara Ahmed', assignment: 'State Management', course: 'React Basics', submitted: '2026-06-09', grade: '92' },
    { id: 3, student: 'Hamza Yousaf', assignment: 'API Integration', course: 'Node.js Course', submitted: '2026-06-08', grade: '85' }
  ]);
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-bg">
                  <tr>
                    <th className="text-left px-4 py-3 text-sm font-semibold text-textDark">Student</th>
                    ...
                    <th className="text-left px-4 py-3 text-sm font-semibold text-textDark">Submitted</th>
                ...
                <tbody>
                  {submissions.map(s => (
                    <tr key={s.id} className="border-t border-border hover:bg-bg">
                      <td className="px-4 py-3 font-semibold text-textDark">{s.student}</td>
                      <td className="px-4 py-3 text-sm text-textDark">{s.assignment}</td>
                      <td className="px-4 py-3 text-sm text-textLight">{s.course}</td>
                      <td className="px-4 py-3 text-sm text-textDark">{s.submitted}</td>
